...
export default function Footer() {
  return (
    <footer className="bg-green text-center text-white  lg:text-left">
        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="">
            <span className="mb-4 flex items-center justify-center  md:justify-start">
              <img src="./logo.png" alt="EdInfoHub" className="w-48 h-48" />
            </span>
          </div>
      ...
      <div className="bg-neutral-200 p-6 text-center dark:bg-neutral-700 border-t-2 border-neutral-200">
        <span>
          &copy; {currentYear}.{" "}
          <a
